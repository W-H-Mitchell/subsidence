...
def output(xyz, disp_tiff, dem, yr, rcp):
    ...
    out_data_frame['severity metric']= 'probabilty'
    ...
    assert out_frame['severity value'].max() <= 1 # check the probability range
    assert out_frame['severity value'].min() >= 0 # check the probability range
    assert out_frame['severity value'].mean() <= 0.1 # check probabilities are not too high
...
output('rcp85xyz/2015-2024.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2020', 'rcp85')
output('rcp85xyz/2020-2029.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2025', 'rcp85')
output('rcp85xyz/2025-2034.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2030', 'rcp85')
output('rcp85xyz/2030-2039.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2035', 'rcp85')
output('rcp85xyz/2035-2044.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2040', 'rcp85')
output('rcp85xyz/2040-2049.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2045', 'rcp85')
output('rcp85xyz/2045-2054.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2050', 'rcp85')
output('rcp85xyz/2050-2059.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2055', 'rcp85')
output('rcp85xyz/2055-2064.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2060', 'rcp85')
output('rcp85xyz/2060-2069.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2065', 'rcp85')
output('rcp85xyz/2065-2074.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2070', 'rcp85')
output('rcp85xyz/2070-2079.xyz', 'tifs/displacement_cmyr.tif', 'tifs/dem_gb.tif' '2075', 'rcp85')
