...
def reproj_climate(ncdf, lyr, tif):
    ...
    cmd = "gdalwarp -overwrite -of  GTiff -t_srs 'epsg:4326' -tr {0} {1} -te {2} {3} {4} {5} NETCDF:'{6}':{7} {8}".format(x_res, y_res,min_x, min_y, max_x, max_y, ncdf, lyr, tif)
    os.system(cmd)
    
def reproj_soil(ncdf, lyr, tif):
    # dem reference raster
    reference_raster = gdal.Open("tifs/dem_gb.tif")
    geo = reference_raster.GetGeoTransform()
    xsize, ysize = reference_raster.RasterXSize, reference_raster.RasterYSize
...
# temperature
reproj_soil("netcdfs/obs_summer_mean_tas_2018.nc", "tas", "tifs/train2018/summer_temperature.tif")
reproj_soil("netcdfs/rcp85_model_2015-2024_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2015-2024_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2020-2029_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2020-2029_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2025-2034_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2025-2034_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2030-2039_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2030-2039_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2035-2044_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2035-2044_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2060-2069_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2060-2069_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2065-2074_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2065-2074_summer_tas.tif")
reproj_soil("netcdfs/rcp85_model_2070-2079_summer_tas.nc", "tas", "tifs/train2018/rcp85_model_2070-2079_summer_tas.tif")
...
reproj_soil("netcdfs/rcp85_mod_summer_mean_soil_moisture_winter-summer_2018_layer_1.nc",
            "unknown", "tifs/train2018/soilmoisture_lyr1.tif")
reproj_soil("netcdfs/rcp85_mod_summer_mean_soil_moisture_winter-summer_2018_layer_2.nc",
            "unknown", "tifs/train2018/soilmoisture_lyr3.tif")   
reproj_soil("netcdfs/rcp85_mod_summer_mean_soil_moisture_winter-summer_2018_layer_3.nc",
            "unknown", "tifs/train2018/soilmoisture_lyr3.tif")         
